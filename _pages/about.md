...
<span style='text-align: justify;'>
🦸🏻‍♀️ I participated in the <b>AnitaB.org Grace Hopper Celebration (GHC) </b> in <b>2022</b> and will also be attending the <b>2023</b> event. I also took on the role of a mentor for <b>Women In Engineering</b>.
</span> <br>
<span style='text-align: justify;'>
🎨 I organized and managed my college's cultural fest in my junior year, displaying my strong passion for art and craft. I also secured the 2nd place in a state-level drawing competition.
</span> <br> -->
...
<div style="padding: 10px 20px; text-align: justify;">
  ...
  <ul style="list-style-type: none; margin-left: 0; padding-left: 20px;">
    <li>Programming Languages: Go, Python, C++, Java, PHP, HTML, CSS, Javascript, Angular</li>
    <li>Tools & Technologies: Docker, RabbitMQ, Redis, Jenkins, Git, Datadog, Jira, Rancher</li>
    <li>Databases: MySQL, Cassandra, Postgres, MongoDB, SQLite</li>
    <li>Cloud Platforms: AWS (S3 & DynamoDB)</li>
